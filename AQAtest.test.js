...
describe('Tests',() => {
    ...
    test.only('3. My profile page. Client area', async() => {
        page = await context.newPage();
        await page.goto('https://www.sbzend.ssls.com/');
        await page.click('button:nth-child(2) > span');
        await page.type('div > input','ssls.automation+666@gmail.com', {timeout: 1000000});
        ...
        var Newsletter = document.querySelector('body > div.container > div > ui-view > div > div.page-content > div > div:nth-child(2) > div > form > div:nth-child(7) > div.description > button > span.toggle-marker');
